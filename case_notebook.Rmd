...
arrows <- data.frame(
  x1 = c(as.Date("2019-06-05"),as.Date("2020-09-19"), as.Date("2020-06-25"), as.Date("2021-04-01")),
  y1 = c(123, 62, 128, 115),
  x2 = c(as.Date("2019-11-20"),as.Date("2020-05-19"), as.Date("2020-03-23"), as.Date("2020-10-10")),
  y2 = c(133, 50, 119, 105)
)
...
ggplot() +
  ...
  labs(title = "Comparação volume de vendas de setor de móveis e eletrodomésticos e o restante do setor varejista",
       subtitle = "Estado de São Paulo. Abril de 2019 até novembro de 2021",
       x = "",
       y = "Índice")+
  ggthemes::theme_clean()

# TODO: indica legenda de geom_line                                  ok
#       aumentar tamanho do gráfico - diminuir dpi?                  off
#       criar seta apontando início da pandemia                      ok
#       label com seta apontando efeito rebote setor de móveis       ok
#       label com seta apontando sazonalidade                        ok
#       label com seta apontando caída da pandemia                   ok
...
# Pelos histogramas, os valores encontrados anteriormente são outliers. Os valores escolhidos como máximo e mínimo da escala do mapa serão 0.5 e 2
...
pmc_map %>% right_join(br_estados) %>% 
  ...
  scale_fill_viridis(option = "D",
                     ...
                     limits = c(0.5, 2))+
  annotate("label", 
           label = "Mapa animado índice de variação do \nvolume de vendas do setor de \nMóveis e Eletrodomésticos", 
  ...
  annotation_custom(
      ...
      ggplotGrob(pmc_bar %>%
        ...
        labs(title = "Tabela animada do índice de volume de vendas por Estado em nível",
...
ggsave(paste0("graphics/png_gif/",i, ".png"), dpi = 500, width = 20, height = 12)
